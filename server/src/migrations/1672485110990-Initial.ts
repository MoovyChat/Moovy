...
export class Initial1672485110990 implements MigrationInterface {
    name = 'Initial1672485110990'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "follow" ("userId" character varying NOT NULL, "followingId" character varying NOT NULL, "follows" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_fb7f37934cfb1fc8375d4a5cd44" PRIMARY KEY ("userId", "followingId"))`);
        await queryRunner.query(`CREATE TABLE "notifications" ("id" SERIAL NOT NULL, "userId" character varying NOT NULL, "message" character varying NOT NULL, "fromUser" character varying NOT NULL, "fromUserPhotoUrl" character varying NOT NULL, "isRead" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_280a5791d317ef497c0c33827ff" PRIMARY KEY ("id", "userId", "fromUser"))`);
        await queryRunner.query(`CREATE TABLE "profile" ("userId" character varying NOT NULL, "firstname" character varying NOT NULL, "lastname" character varying NOT NULL, "dob" character varying NOT NULL, "bio" character varying NOT NULL, "gender" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_a24972ebd73b106250713dcddd9" PRIMARY KEY ("userId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_55fa77524d645b5de4d4fb5626" ON "profile" ("firstname") `);
        await queryRunner.query(`CREATE INDEX "IDX_5ca44390a3d0281f818f326db8" ON "profile" ("lastname") `);
        ...
        await queryRunner.query(`CREATE TABLE "reply" ("id" SERIAL NOT NULL, "message" character varying NOT NULL, "movieId" character varying NOT NULL, "parentCommentId" integer NOT NULL, "commentedUserName" character varying NOT NULL, "parentReplyId" character varying NOT NULL, "parentRepliedUser" character varying NOT NULL, "commentedUserId" character varying NOT NULL, "likesCount" integer NOT NULL DEFAULT '0', "repliesCount" integer NOT NULL DEFAULT '0', "platformId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "pk_reply_id" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "comment" ("id" SERIAL NOT NULL, "commentedUserId" character varying NOT NULL, "commentedUserName" character varying NOT NULL, "message" character varying NOT NULL, "movieId" character varying NOT NULL, "likesCount" integer NOT NULL DEFAULT '0', "repliesCount" integer NOT NULL DEFAULT '0', "platformId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "pk_comment_id" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_5ca44390a3d0281f818f326db8"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_55fa77524d645b5de4d4fb5626"`);
