    ...
    <PrivacyPolicyWrapper>
      ...
      <PrivacyPolicyContent>
        ...
        <p>
          ...
          use of MoovyChat Ltd.'s website, located at https://www.moovychat.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use MoovyChat Ltd. if you do not agree
        ...
        <h3>Cookies</h3>
        <p>
          We employ the use of cookies. By accessing MoovyChat Ltd., you agreed
          to use cookies in agreement with the MoovyChat Ltd.'s Privacy Policy.
        </p>

        <h3>Refunds and Cancellations</h3>
        <p>
          MoovyChat does not offer refunds for any reason. Once you purchase a
          subscription or make a payment for the Service, the transaction is
          final and no refund will be issued.
        </p>

        <h3>License</h3>
        <p>
          Unless otherwise stated, MoovyChat Ltd. and/or its licensors own the
          ...
          and/or print pages from https://www.moovychat.com for your own
        ...
        <p>
          ...
          the hyperlink compensates the absence of MoovyChat Ltd.; and (d) the
        ...
        <p>
          ...
          agree to immediately remove all links to our Website upon such
          ...
          Website, you agree to be bound to and abide by these linking terms and
          conditions.
        </p>
        ...
        <p>
          ...
          breach of statutory duty, except to the extent expressly provided in
          this disclaimer.
        </p>
        <p>
