...
export type CreateRoomInput = {
  ...
  movie?: InputMaybe<RoomMovieInput>;
...
export type Room = {
  ...
  name: Scalars['String'];
  roomType: RoomType;
  show?: Maybe<RoomMovieObject>;
  users: Array<Users>;
};

export type RoomMovieInput = {
  id: Scalars['String'];
  name: Scalars['String'];
  parentTitleName: Scalars['String'];
...
export type RoomMovieObject = {
  __typename?: 'RoomMovieObject';
  id: Scalars['String'];
  name: Scalars['String'];
  parentTitleName: Scalars['String'];
...
export type DeleteCommentMutation = { __typename?: 'Mutation', deleteComment?: { __typename?: 'Comment', id: string, message: string, commentedUserId: string, movieId: string, createdAt?: string | null, deletedAt?: string | null } | null };
...
export type GetCommentedUserQuery = { __typename?: 'Query', getCommentedUser?: { __typename: 'Users', id: string, name: string, email: string, photoUrl: string, bg?: string | null, nickname: string, followerCount?: number | null, followingCount?: number | null, joinedAt?: string | null, updatedAt?: string | null, deletedAt?: string | null } | null };
...
export type CommentLikesSubscription = { __typename?: 'Subscription', commentLikesUpdate: { __typename?: 'CommentLikesObject', likesCount: number, likes: Array<{ __typename: 'Users', id: string, name: string, email: string, photoUrl: string, bg?: string | null, nickname: string, followerCount?: number | null, followingCount?: number | null, joinedAt?: string | null, updatedAt?: string | null, deletedAt?: string | null }> } };
...
export type FullCommentFragment = { __typename: 'Comment', id: string, commentedUserId: string, commentedUserName: string, message: string, movieId: string, likesCount?: number | null, repliesCount?: number | null, platformId: number, toxicityScore?: number | null, flagged?: boolean | null, type?: string | null, createdAt?: string | null, updatedAt?: string | null, deletedAt?: string | null };
...
export type FullUserFragment = { __typename: 'Users', id: string, name: string, email: string, photoUrl: string, bg?: string | null, nickname: string, followerCount?: number | null, followingCount?: number | null, joinedAt?: string | null, updatedAt?: string | null, deletedAt?: string | null };
...
export type InsertMovieInformationMutationVariables = Exact<{
  mid: Scalars['String'];
  options: MovieFullInformation;
}>;


export type InsertMovieInformationMutation = { __typename?: 'Mutation', insertMovieInformation?: { __typename: 'Movie', id: string, name: string, runtime?: number | null, platformId: number, createdAt: string, updatedAt: string, thumbs?: string | null, season?: string | null, likesCount: number, commentCount: number, viewsCount: number, favCount: number, titleId: string, parentTitleName?: string | null, stills?: string | null, synopsis?: string | null, year?: number | null } | null };
...
export type GetMovieLikesQuery = { __typename?: 'Query', getMovieLikes?: { __typename?: 'LikesObject', likesCount: number, likes?: Array<{ __typename: 'Users', id: string, name: string, email: string, photoUrl: string, bg?: string | null, nickname: string, followerCount?: number | null, followingCount?: number | null, joinedAt?: string | null, updatedAt?: string | null, deletedAt?: string | null }> | null } | null };
...
export type GetRepliedUserQuery = { __typename?: 'Query', getRepliedUser?: { __typename: 'Users', id: string, name: string, email: string, photoUrl: string, bg?: string | null, nickname: string, followerCount?: number | null, followingCount?: number | null, joinedAt?: string | null, updatedAt?: string | null, deletedAt?: string | null } | null };
...
export type GetCommentRepliesQuery = { __typename?: 'Query', getCommentReplies: { __typename?: 'ReplyConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean }, nodes: Array<{ __typename: 'Reply', id: string, message: string, movieId: string, parentCommentId: string, commentedUserName?: string | null, parentReplyId?: string | null, parentRepliedUser?: string | null, commentedUserId: string, likesCount?: number | null, repliesCount?: number | null, platformId: number, type?: string | null, createdAt: string, updatedAt: string, deletedAt?: string | null }>, edges: Array<{ __typename?: 'ReplyEdge', node?: { __typename: 'Reply', id: string, message: string, movieId: string, parentCommentId: string, commentedUserName?: string | null, parentReplyId?: string | null, parentRepliedUser?: string | null, commentedUserId: string, likesCount?: number | null, repliesCount?: number | null, platformId: number, type?: string | null, createdAt: string, updatedAt: string, deletedAt?: string | null } | null }> } };
...
export type CreateRoomMutation = { __typename?: 'Mutation', createRoom?: { __typename?: 'Room', id: string, name: string, roomType: RoomType, show?: { __typename?: 'RoomMovieObject', id: string, name: string, parentTitleName: string, thumbs: string, platform?: string | null } | null } | null };
...
export type GetUserByNickNameMutation = { __typename?: 'Mutation', getUserByNickName?: { __typename: 'Users', id: string, name: string, email: string, photoUrl: string, bg?: string | null, nickname: string, followerCount?: number | null, followingCount?: number | null, joinedAt?: string | null, updatedAt?: string | null, deletedAt?: string | null } | null };
...
export type GetUserMutMutation = { __typename?: 'Mutation', getUserMut?: { __typename: 'Users', id: string, name: string, email: string, photoUrl: string, bg?: string | null, nickname: string, followerCount?: number | null, followingCount?: number | null, joinedAt?: string | null, updatedAt?: string | null, deletedAt?: string | null } | null };
...
export type UpdateUserNickNameMutation = { __typename?: 'Mutation', updateUserNickName: { __typename?: 'NickNameResponse', errors?: Array<{ __typename?: 'ErrorField', field: string, message: string }> | null, user?: { __typename: 'Users', id: string, name: string, email: string, photoUrl: string, bg?: string | null, nickname: string, followerCount?: number | null, followingCount?: number | null, joinedAt?: string | null, updatedAt?: string | null, deletedAt?: string | null } | null } };
...
export type GetAllUsersQuery = { __typename?: 'Query', users: Array<{ __typename: 'Users', id: string, name: string, email: string, photoUrl: string, bg?: string | null, nickname: string, followerCount?: number | null, followingCount?: number | null, joinedAt?: string | null, updatedAt?: string | null, deletedAt?: string | null }> };
...
export type GetUserQuery = { __typename?: 'Query', getUser?: { __typename: 'Users', id: string, name: string, email: string, photoUrl: string, bg?: string | null, nickname: string, followerCount?: number | null, followingCount?: number | null, joinedAt?: string | null, updatedAt?: string | null, deletedAt?: string | null } | null };
...
export type GetAllVersionsQuery = { __typename?: 'Query', getAllVersions: Array<{ __typename?: 'Version', version: string, createdAt: string, updatedAt: string, deletedAt?: string | null }> };

export type GetVersionNumberQueryVariables = Exact<{ [key: string]: never; }>;


export type GetVersionNumberQuery = { __typename?: 'Query', getVersionNumber?: { __typename?: 'Version', version: string, notes?: string | null, mandatory?: boolean | null, createdAt: string, updatedAt: string, deletedAt?: string | null } | null };
...
export function useCommentLikesSubscription<TData = CommentLikesSubscription>(options: Omit<Urql.UseSubscriptionArgs<CommentLikesSubscriptionVariables>, 'query'> = {variables:{cid:''}}, handler?: Urql.SubscriptionHandler<CommentLikesSubscription, TData>) {
...
export const InsertMovieInformationDocument = gql`
    mutation InsertMovieInformation($mid: String!, $options: MovieFullInformation!) {
  insertMovieInformation(mid: $mid, options: $options) {
    ...FullMovie
  }
}
    ${FullMovieFragmentDoc}`;

export function useInsertMovieInformationMutation() {
  return Urql.useMutation<InsertMovieInformationMutation, InsertMovieInformationMutationVariables>(InsertMovieInformationDocument);
};
...
export function useGetAllVersionsQuery(options?: Omit<Urql.UseQueryArgs<GetAllVersionsQueryVariables>, 'query'>) {
  return Urql.useQuery<GetAllVersionsQuery, GetAllVersionsQueryVariables>({ query: GetAllVersionsDocument, ...options });
};
...
export function useGetVersionNumberQuery(options?: Omit<Urql.UseQueryArgs<GetVersionNumberQueryVariables>, 'query'>) {
  return Urql.useQuery<GetVersionNumberQuery, GetVersionNumberQueryVariables>({ query: GetVersionNumberDocument, ...options });
};
