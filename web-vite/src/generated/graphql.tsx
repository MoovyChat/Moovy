...
export type FullMovieStatsFragment = {
  __typename?: "MovieStats";
  like?: boolean | null;
...
export type InsertMovieInfoMutation = {
  __typename?: "Mutation";
  insertTitle?: boolean | null;
};
...
export type InsertMovieInformationMutation = {
  __typename?: "Mutation";
  insertMovieInformation?: {
    __typename: "Movie";
    id: string;
    name: string;
    runtime?: number | null;
...
export type UpdateMovieViewCountMutation = {
  __typename?: "Mutation";
  updateMovieViewCount?: number | null;
};
...
export type MovieStatusUpdateSubscriptionVariables = Exact<{
  [key: string]: never;
}>;

export type MovieStatusUpdateSubscription = {
  __typename?: "Subscription";
  movieStatusUpdate: {
    __typename?: "LikesAndFavObj";
...
export type AdminNotificationsSubscriptionVariables = Exact<{
  [key: string]: never;
}>;

export type AdminNotificationsSubscription = {
  __typename?: "Subscription";
  adminNotifications: {
    __typename?: "AdminNotifications";
    id: string;
...
export type GetLatestAdminNotificationQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetLatestAdminNotificationQuery = {
  __typename?: "Query";
...
export type ReportReplyMutation = {
  __typename?: "Mutation";
  reportReply?: {
    __typename?: "ReplyReport";
    usersId: string;
...
export type InsertVisitedMutation = {
  __typename?: "Mutation";
  insertVisited?: {
    __typename?: "Visited";
    userId: string;
...
export function useInsertMovieInfoMutation() {
  return Urql.useMutation<
    InsertMovieInfoMutation,
    InsertMovieInfoMutationVariables
  >(InsertMovieInfoDocument);
}
...
export const InsertMovieInformationDocument = gql`
  mutation InsertMovieInformation(
    $mid: String!
    $options: MovieFullInformation!
  ) {
...
export function useInsertMovieInformationMutation() {
  return Urql.useMutation<
    InsertMovieInformationMutation,
    InsertMovieInformationMutationVariables
  >(InsertMovieInformationDocument);
}
...
export function useUpdateMovieViewCountMutation() {
  return Urql.useMutation<
    UpdateMovieViewCountMutation,
    UpdateMovieViewCountMutationVariables
  >(UpdateMovieViewCountDocument);
}
...
export function useGetOnlyUserMovieStatsQuery(
  options: Omit<Urql.UseQueryArgs<GetOnlyUserMovieStatsQueryVariables>, "query">
) {
  return Urql.useQuery<
...
export function useMovieStatusUpdateSubscription<
  TData = MovieStatusUpdateSubscription
>(
  options: Omit<
    Urql.UseSubscriptionArgs<MovieStatusUpdateSubscriptionVariables>,
    "query"
  > = {},
  handler?: Urql.SubscriptionHandler<MovieStatusUpdateSubscription, TData>
) {
  return Urql.useSubscription<
    MovieStatusUpdateSubscription,
    TData,
    MovieStatusUpdateSubscriptionVariables
  >({ query: MovieStatusUpdateDocument, ...options }, handler);
}
...
export function useAdminNotificationsSubscription<
  TData = AdminNotificationsSubscription
>(
  options: Omit<
    Urql.UseSubscriptionArgs<AdminNotificationsSubscriptionVariables>,
    "query"
  > = {},
  handler?: Urql.SubscriptionHandler<AdminNotificationsSubscription, TData>
) {
  return Urql.useSubscription<
    AdminNotificationsSubscription,
    TData,
    AdminNotificationsSubscriptionVariables
  >({ query: AdminNotificationsDocument, ...options }, handler);
}
...
export function useGetLatestAdminNotificationQuery(
  options?: Omit<
    Urql.UseQueryArgs<GetLatestAdminNotificationQueryVariables>,
    "query"
  >
) {
  return Urql.useQuery<
    GetLatestAdminNotificationQuery,
    GetLatestAdminNotificationQueryVariables
  >({ query: GetLatestAdminNotificationDocument, ...options });
}
...
export function useReportReplyMutation() {
  return Urql.useMutation<ReportReplyMutation, ReportReplyMutationVariables>(
    ReportReplyDocument
  );
}
...
export function useIsReportedQuery(
  options: Omit<Urql.UseQueryArgs<IsReportedQueryVariables>, "query">
) {
  return Urql.useQuery<IsReportedQuery, IsReportedQueryVariables>({
    query: IsReportedDocument,
    ...options,
  });
}
...
export const InsertVisitedDocument = gql`
  mutation insertVisited(
    $time: Float!
    $insertVisitedId: String!
    $mid: String!
    $uid: String!
  ) {
...
export function useInsertVisitedMutation() {
  return Urql.useMutation<
    InsertVisitedMutation,
    InsertVisitedMutationVariables
  >(InsertVisitedDocument);
}
